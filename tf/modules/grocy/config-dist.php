...
DefaultUserSetting('keep_screen_on', true); // Keep the screen always on
DefaultUserSetting('keep_screen_on_when_fullscreen_card', true); // Keep the screen on when a "fullscreen-card" is displayed
...
DefaultUserSetting('stock_default_purchase_amount', 1);
